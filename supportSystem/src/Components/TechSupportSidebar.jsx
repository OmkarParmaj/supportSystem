...
const TechSupportSidebar = ({ isLoggedIn, setIsLoggedIn }) => {
                ...
                <div className="offcanvas-body">
                    <ul className="mynav nav nav-pills flex-column mb-auto">
                        <li className="nav-item mb-1 rounded-2 mt-1">
                            <Link to="/techsupportdashboard" className="text-decoration-none links d-flex ms-3" >Dashboard</Link>
                        </li>
                        <li className="nav-item mb-1 rounded-2 mt-1">
                            <Link to="/resolveticket" className="text-decoration-none links d-flex ms-3" >Resolve Rised Ticket</Link>
                        </li>
...
export default TechSupportSidebar;
