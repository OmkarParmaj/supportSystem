...
const AdminDashboard = ({ isLoggedIn, setIsLoggedIn }) => {
    ...
    useEffect(() => {
        axios.get('http://localhost:7000/admindash')
            .then(res => {
    ...
    return (
        <>
            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    <div className="col-2">
                        <AdminSidebar isLoggedIn={isLoggedIn} setIsLoggedIn={setIsLoggedIn}></AdminSidebar>
                    </div>
                                ...
                                <tbody>
                                    {clientdata.map((o, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>{o.status}</td>
                                            <td>{o.file}</td>
                                            <td><Link to={`http://localhost:5173/adminclientticket/${o.uid}`} type="submit" className="btn btn-primary">OPEN</Link></td>
